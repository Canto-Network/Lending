...
const func: DeployFunction = async function(hre: HardhatRuntimeEnvironment) {
    ...
    const USDC = await deploy("USDC", {
        ...
        from: deployer,
        log: true,
        args: ["USDC", "USDC", ethers.utils.parseUnits("10000000", 6), 6]
    });
    ...
    const USDT = await deploy("USDT", {
        ...
        from: deployer,
        log: true,
        args: ["USDT", "USDT", ethers.utils.parseUnits("10000000", 6), 6]
    });
    ...
    const ATOM = await deploy("ATOM", {
        ...
        from: deployer,
        log: true,
        args: ["ATOM", "ATOM", ethers.utils.parseUnits("10000000", 8), 8]
    });
